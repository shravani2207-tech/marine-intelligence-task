...
tributary_records = [
    {"name": "Yamuna", "parent": "Ganga", "coords": [(77.0, 31.0), (81.8, 25.4)]},
    {"name": "Ghaghara", "parent": "Ganga", "coords": [(80.8, 30.2), (84.3, 25.8)]},
    {"name": "Gandak", "parent": "Ganga", "coords": [(83.8, 27.4), (85.2, 25.7)]},
    {"name": "Kosi", "parent": "Ganga", "coords": [(86.5, 27.5), (87.3, 25.6)]},
    {"name": "Son", "parent": "Ganga", "coords": [(81.6, 23.5), (84.8, 25.6)]},
]

gdf_tributaries = gpd.GeoDataFrame(
    {
        "tributary_name": [t["name"] for t in tributary_records],
        "parent_river": [t["parent"] for t in tributary_records],
        "geometry": [LineString(t["coords"]) for t in tributary_records],
    },
    crs=GEO_CRS,
)

print(f"Registered {len(gdf_tributaries)} tributaries.")
waterway_list = [
